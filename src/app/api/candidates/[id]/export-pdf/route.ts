...
export async function GET(
  ...
  console.log("🚀 PDF Export API - Starting candidate PDF export");
  ...
  try {
    ...
    const filename = `${candidate.candidateName.replace(/[^a-zA-Z0-9]/g, "_")}-SurveyReport-${new Date().toISOString().split("T")[0]}.pdf`;
